...
function! s:in_parameter_expansion()
  let l:line = line('.')
...
xnoremap <buffer> <silent> iv :<C-u>call <SID>in_parameter_expansion()<CR>
onoremap <buffer> <silent> iv :<C-u>call <SID>in_parameter_expansion()<CR>
